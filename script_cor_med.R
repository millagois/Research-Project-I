...
#in this analysis I will use all the bifidobacterium genres as the bifidobacteria abundance
...
bifido_updated <- updated_bacteria [171:210, ]
bifido_updated <- bifido_updated [c(3,6,29,32,35),]
